...
function VseriesMoped({allStock}) {
    const [data, setdata ] = useState([]);

    async function getData() {
        const url = "http://localhost:3000/stockBikes/v_series_moped";
...
const [value,setValue] = useState(allStock[0]?.image_url);
