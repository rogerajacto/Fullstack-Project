...
function VseriesClassic({allStock}) {
    const [data, setdata ] = useState([]);

    async function getData() {
        const url = "http://localhost:3000/stockBikes/v_series_classic";
...
const [value,setValue] = useState(allStock[4]?.image_url);
...
const options = [
    ...
    {label: "Purple", value:data[2]?.image_url}
]
