...
function RseriesRaw({allStock}) {

    const [data, setdata ] = useState([]);

    async function getData() {
        const url = "http://localhost:3000/stockBikes/r_series_raw";
...
const [value,setValue] = useState(allStock[18]?.image_url);
...
const options = [
    ...
    {label: "Green Glowing", value:data[2]?.image_url}
]
